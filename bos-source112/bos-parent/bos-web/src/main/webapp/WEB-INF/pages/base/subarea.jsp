...
<script type="text/javascript">
	...
	function doImport(){
		alert("导入");
		//发送请求
		//$.post("subareaAction_exportXls.action",function(){
			//不刷新
			//alert(1);
		///});
	...
	$(function(){
		...
		$("#btn").click(function(){
			//调用数据表格load方法,重新发送ajax请求.
				//"province":$("input[name=provice]").val(),
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<!-- 用户展示图表 -->
	<div class="easyui-window" title="区域分布图" id="showSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div id="test"  >
