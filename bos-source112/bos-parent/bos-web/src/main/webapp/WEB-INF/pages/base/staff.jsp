...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if(rows.length==0){
			$.messager.alert("提示信息","请选择删除的项目","info");
		}else{
			$.messager.confirm("删除确认","删除这些数据 ?",function(r){
				if (r) {
					var array = new Array();
					...
					<tr>
						...
						$(function () {
							$("#save").click(function () {
								...
								if (v) {
									//$("#addStaffForm").form("submit"); //不使用ajax刷新页面
									$("#addStaffForm").submit(); 
								}
							});
