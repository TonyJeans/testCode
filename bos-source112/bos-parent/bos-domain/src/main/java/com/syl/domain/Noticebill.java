...
public class Noticebill implements java.io.Serializable {
	...
	private String ordertype;//分单类型自动\人工
	...
	/** full constructor */
	public Noticebill(String id, User user, Staff staff,
			String customerId, String customerName, String delegater,
			String telephone, String pickaddress, String arrivecity,
			String product, Date pickdate, Integer num, Double weight,
			String volume, String remark, String ordertype, Set workBills) {
		this.id = id;
		this.user = user;
		this.staff = staff;
