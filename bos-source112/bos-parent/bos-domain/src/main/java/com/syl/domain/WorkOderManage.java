...
/**
 * WorkOderManage entity. @author MyEclipse Persistence Tools
 * 工作单
 */

public class WorkOderManage implements java.io.Serializable {
	...
	/** default constructor */
	public WorkOderManage() {
	}

	/** minimal constructor */
	public WorkOderManage(String id) {
		this.id = id;
	}

	/** full constructor */
	public WorkOderManage(String id, String arrivecity, String product,
